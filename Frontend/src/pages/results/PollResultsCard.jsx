    ...
    <div className={`bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow ${
      ...
      <div className="space-y-3 mb-6" key={animationKey}>
        {voteDistribution.length > 0 ? (
          voteDistribution.map((option, index) => (
            <div key={`${option.option}-${index}`} className="space-y-1">
      ...
      <div className="grid grid-cols-3 gap-4 pt-4 border-t border-gray-200">
        <div className="text-center">
          <div className="text-2xl font-bold text-blue-600" key={`total-${metrics.totalVotes}`}>
            {metrics.totalVotes}
          </div>
        ...
        <div className="text-center">
          <div className={`text-2xl font-bold ${getEngagementColor(metrics.engagementRate)}`} key={`engagement-${metrics.engagementRate}`}>
        ...
        <div className="text-center">
          <div className="text-2xl font-bold text-purple-600" key={`participation-${metrics.participationRate}`}>
