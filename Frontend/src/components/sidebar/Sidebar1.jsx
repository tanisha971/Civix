...
export default function Sidebar1() {
  ...
  return (
    <div style={{ width: '100%', padding: 24, textAlign: 'center' }}>
      <Avatar src="https://randomuser.me/api/portraits/men/75.jpg" sx={{ width: 72, height: 72, margin: '0 auto' }} />
      <h2 style={{ margin: '16px 0 8px', fontWeight: 600 }}>Tanisha</h2>
      ...
      <div style={{ marginTop: 12, color: '#555', fontSize: 14 }}>
        <LocationOnIcon fontSize="small" /> Delhi, India
      </div>
      <div style={{ marginTop: 4, color: '#555', fontSize: 14 }}>
        <EmailIcon fontSize="small" /> tanisha@email.com
      </div>
    </div>
  );
}
